...
public static b4a.example.main _main = null;
  public Object[] GetGlobals() {
		return new Object[] {"HttpUtils2Service",starter.mostCurrent._httputils2service,"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}